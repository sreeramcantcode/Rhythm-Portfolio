  ...
  return (
    <div className="w-full overflow-hidden bg-black relative bottom-3 mt-4">
      <div ref={trackRef} className="flex w-max gap-4">
        ...
        <div className="lg:h-90 hidden  mb-20  mt-12 pt-10 lg:pt-0 lg:flex justify-center items-center">
      ...
      <button onClick={()=> navigate("/All")}className=" lg:hidden md:hidden rounded-lg text-sm  hover:bg-red-900 button hover:text-black duration-200 bg-white font-semibold text-black cursor-pointer border-black w-30  p-2 hover:scale-105">Explore Projects</button>
      </div>
