...
function FolderPopup({ images, onClose }) {
  ...
  return (
    <>
      ...
      >
        <div
          className="relative bg-linear-to-tl from-black to-red-950 p-6 rounded-xl w-[80%] max-w-4xl"
      ...
      {activeImage && (
        <div
          className="fixed inset-0 bg-black/80   z-50 flex items-center md:p-10 justify-center"
