...
gsap.registerPlugin(ScrollToPlugin)
    ...
    return(
        ...
        >
            ...
            <img
                className="opacity-20 w-40 sm:w-56 md:w-72 md:scale-135"
                src={logo}
                alt=""
            />
            ...
            <div className="
                w-fit relative
                p-4 sm:p-8
                translate-x-0 sm:translate-x-7
                ml-0 sm:ml-5
            ">
                ...
                <h1>
                    ...
                    <span>
                    <a
                        href="mailto:rhymexmedia@gmail.com"
                        target="_blank"
                    >
                ...
                <div className="Mobile text-gray-300 text-sm sm:text-lg mt-2">
                <h1>
                    Mobile :
